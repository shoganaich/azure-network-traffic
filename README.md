...
In this tutorial, we will use Wireshark to observe network traffic between Azure Virtual Machines and experiment with Network Security Groups. 
...
- Various Network Protocols (ICMP, SSH, DHCP, HTTP/S, DNS)
